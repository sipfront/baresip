...
int call_send_digit(struct call *call, char key)
{
	...
	if (key == '0') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_0, call, "%c", key);
	}
	else if (key == '1') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_1, call, "%c", key);
	}
	else if (key == '2') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_2, call, "%c", key);
	}
	else if (key == '3') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_3, call, "%c", key);
	}
	else if (key == '4') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_4, call, "%c", key);
	}
	else if (key == '5') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_5, call, "%c", key);
	}
	else if (key == '6') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_6, call, "%c", key);
	}
	else if (key == '7') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_7, call, "%c", key);
	}
	else if (key == '8') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_8, call, "%c", key);
	}
	else if (key == '9') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_9, call, "%c", key);
	}
	else if (key == 'A') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_A, call, "%c", key);
	}
	else if (key == 'B') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_B, call, "%c", key);
	}
	else if (key == 'C') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_C, call, "%c", key);
	}
	else if (key == 'D') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_D, call, "%c", key);
	}
	else if (key == '*') {
		bevent_call_emit(UA_EVENT_CALL_SND_DTMF_ASTERISK,
			call, "%c", key);
	}
	else if (key == '#') {
