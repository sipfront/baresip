...
const char *uag_event_str(enum ua_event ev)
{
	...
	case UA_EVENT_CALL_SND_DTMF_3:      return "CALL_SND_DTMF_3";
	case UA_EVENT_CALL_SND_DTMF_4:      return "CALL_SND_DTMF_4";
	case UA_EVENT_CALL_SND_DTMF_5:      return "CALL_SND_DTMF_5";
	case UA_EVENT_CALL_SND_DTMF_6:      return "CALL_SND_DTMF_6";
	case UA_EVENT_CALL_SND_DTMF_7:      return "CALL_SND_DTMF_7";
	case UA_EVENT_CALL_SND_DTMF_8:      return "CALL_SND_DTMF_8";
	case UA_EVENT_CALL_SND_DTMF_9:      return "CALL_SND_DTMF_9";
	case UA_EVENT_CALL_SND_DTMF_A:      return "CALL_SND_DTMF_A";
	case UA_EVENT_CALL_SND_DTMF_B:      return "CALL_SND_DTMF_B";
	case UA_EVENT_CALL_SND_DTMF_C:      return "CALL_SND_DTMF_C";
